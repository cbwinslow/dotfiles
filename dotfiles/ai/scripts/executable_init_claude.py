#!/usr/bin/env python3
"""
Auto-initialization script for claude agent
"""
...
def initialize_agent():
    logger.info("Initializing claude agent with global rules...")
...
def setup_shell_integration():
    ...
    shell_config = """
# Agent AI Skills System - claude Agent
export AI_SKILLS_SYSTEM="/home/cbwinslow/dotfiles/ai"
export CLAUDE_RULES="$AI_SKILLS_SYSTEM/global_rules/agent_init_rules.md"
...
if __name__ == "__main__":
    if initialize_agent():
        ...
        logger.info("🎉 claude agent setup complete!")
        sys.exit(0)
    else:
        logger.error("❌ claude agent setup failed!")
        sys.exit(1)
