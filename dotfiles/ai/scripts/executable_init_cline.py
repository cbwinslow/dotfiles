#!/usr/bin/env python3
"""
Auto-initialization script for cline agent
"""
...
def initialize_agent():
    logger.info("Initializing cline agent with global rules...")
    ...
    logger.info(f"✓ cline agent initialized successfully")
    return True
...
def setup_shell_integration():
    ...
    shell_config = """
# Agent AI Skills System - cline Agent
export AI_SKILLS_SYSTEM="/home/cbwinslow/dotfiles/ai"
export CLINE_RULES="$AI_SKILLS_SYSTEM/global_rules/agent_init_rules.md"
...
if __name__ == "__main__":
    if initialize_agent():
        ...
        logger.info("🎉 cline agent setup complete!")
        sys.exit(0)
    else:
        logger.error("❌ cline agent setup failed!")
        sys.exit(1)
