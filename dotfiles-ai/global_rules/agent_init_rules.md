...
- **MANDATORY**: Use Agent Memory System for all persistent storage
...
def save_conversation_to_letta(agent_name, conversation_history):
    ...
    # Implementation using agent_memory package
    pass
...
from agent_memory import get_agent_context, store_agent_context

class AgentMemoryAgent(Agent):
...
from agent_memory import store_agent_context

class AgentMemoryAssistant(AssistantAgent):
    def __init__(self, name, **kwargs):
...
// VS Code settings.json
{
  ...
  "aiAgents.memoryBackend": "agent_memory",
...
```python
# agent_setup.py
from agent_memory import initialize_agent_with_rules
...
from agent_memory import save_conversation_to_letta
