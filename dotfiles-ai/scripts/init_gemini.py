#!/usr/bin/env python3
"""
Auto-initialization script for gemini agent
"""
...
def initialize_agent():
    logger.info("Initializing gemini agent with global rules...")
    ...
    logger.info(f"✓ gemini agent initialized successfully")
    return True
...
def setup_shell_integration():
    ...
    shell_config = """
# Agent AI Skills System - gemini Agent
export AI_SKILLS_SYSTEM="/home/cbwinslow/dotfiles/ai"
export GEMINI_RULES="$AI_SKILLS_SYSTEM/global_rules/agent_init_rules.md"
...
if __name__ == "__main__":
    if initialize_agent():
        ...
        logger.info("🎉 gemini agent setup complete!")
        sys.exit(0)
    else:
        logger.error("❌ gemini agent setup failed!")
        sys.exit(1)
