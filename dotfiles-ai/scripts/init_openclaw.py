#!/usr/bin/env python3
"""
Auto-initialization script for openclaw agent
"""
...
def initialize_agent():
    logger.info("Initializing openclaw agent with global rules...")
    ...
    logger.info(f"✓ openclaw agent initialized successfully")
    return True
...
def setup_shell_integration():
    ...
    shell_config = """
# Agent AI Skills System - openclaw Agent
export AI_SKILLS_SYSTEM="/home/cbwinslow/dotfiles/ai"
export OPENCLAW_RULES="$AI_SKILLS_SYSTEM/global_rules/agent_init_rules.md"
...
if __name__ == "__main__":
    if initialize_agent():
        ...
        logger.info("🎉 openclaw agent setup complete!")
        sys.exit(0)
    else:
        logger.error("❌ openclaw agent setup failed!")
        sys.exit(1)
