#!/usr/bin/env python3
"""
Auto-initialization script for opencode agent
"""
...
def initialize_agent():
    logger.info("Initializing opencode agent with global rules...")
    ...
    logger.info(f"✓ opencode agent initialized successfully")
    return True
...
def setup_shell_integration():
    ...
    shell_config = """
# Agent AI Skills System - opencode Agent
export AI_SKILLS_SYSTEM="/home/cbwinslow/dotfiles/ai"
export OPENCODE_RULES="$AI_SKILLS_SYSTEM/global_rules/agent_init_rules.md"
...
if __name__ == "__main__":
    if initialize_agent():
        ...
        logger.info("🎉 opencode agent setup complete!")
        sys.exit(0)
    else:
        logger.error("❌ opencode agent setup failed!")
        sys.exit(1)
