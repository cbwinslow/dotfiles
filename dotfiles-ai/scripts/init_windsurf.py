#!/usr/bin/env python3
"""
Auto-initialization script for windsurf agent
"""
...
def initialize_agent():
    logger.info("Initializing windsurf agent with global rules...")
    ...
    logger.info(f"✓ windsurf agent initialized successfully")
    return True
...
def setup_shell_integration():
    ...
    shell_config = """
# Agent AI Skills System - windsurf Agent
export AI_SKILLS_SYSTEM="/home/cbwinslow/dotfiles/ai"
export WINDSURF_RULES="$AI_SKILLS_SYSTEM/global_rules/agent_init_rules.md"
...
if __name__ == "__main__":
    if initialize_agent():
        ...
        logger.info("🎉 windsurf agent setup complete!")
        sys.exit(0)
    else:
        logger.error("❌ windsurf agent setup failed!")
        sys.exit(1)
