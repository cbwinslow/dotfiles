#!/usr/bin/env python3
"""
Auto-initialization script for kilocode agent
"""
...
def initialize_agent():
    logger.info("Initializing kilocode agent with global rules...")
    ...
    logger.info(f"✓ kilocode agent initialized successfully")
    return True
...
def setup_shell_integration():
    ...
    shell_config = """
# Agent AI Skills System - kilocode Agent
export AI_SKILLS_SYSTEM="/home/cbwinslow/dotfiles/ai"
export KILOCODE_RULES="$AI_SKILLS_SYSTEM/global_rules/agent_init_rules.md"
...
if __name__ == "__main__":
    if initialize_agent():
        ...
        logger.info("🎉 kilocode agent setup complete!")
        sys.exit(0)
    else:
        logger.error("❌ kilocode agent setup failed!")
        sys.exit(1)
